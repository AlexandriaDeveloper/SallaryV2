...
import { NewEmployeeOrderDialog22Component } from './new-employee-order-dialog/new-employee-order-dialog.component';
...
export class OrdersDetails2Component  implements AfterViewInit, OnInit{
  ...
  openDialog(): void {
    const dialogRef = this.dialog.open(NewEmployeeOrderDialog22Component, {
